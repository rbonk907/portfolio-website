    ...
    return (
        <ProjectLayout>
            ...
            <section className="w-full flex flex-col items-end py-8 px-6 md:px-20">
                ...
                <p className="text-justify text-sm leading-6 max-w-2xl">
                    The ultimate goal of this project was to practice PERN development, so some of the technologies used lack a greater explanation for their choice other than “it would not be a PERN app without it.” That said, this project does not use “vanilla” React, but the React framework Next.js, instead. At the time of writing this, the official React documentation recommends using a React Framework, so I chose Next.js due to having a pleasant experience with it in the past (including the development of this portfolio website). 
                </p>
            </section>
            <section className="w-full flex flex-col items-start py-8 px-6 md:px-20">
            ...
            <section className="w-full flex flex-col items-center py-8 px-6 md:px-20">
                ...
                <p className="text-justify text-sm leading-6 max-w-4xl">
